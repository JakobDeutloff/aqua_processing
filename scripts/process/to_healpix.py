...
ds = (
    xr.open_mfdataset(
        "/work/bm1183/m301049/icon-mpim-2K/experiments/jed0033/jed0033_atm_2d_19*.nc",
        chunks={"time": 1},
    )
    .pipe(merge_grid)
    .pipe(fix_time)
...
# %% regrid to healpix
to_healpix(ds_coarse, save_path="/work/bm1183/m301049/icon_hcap_data/plus2K/production/jed0033_atm_2d_hp.nc")
