...
# %% load data
ds = xr.open_dataset(
    f"/work/bm1183/m301049/icon_hcap_data/control/production/random_sample/jed0011_randsample_processed.nc"
...
axes[1].plot(cre["iwp"], cre["sw"], color="blue", label="SW")
axes[1].plot(cre["iwp"], cre["lw"], color="red", label="LW")
axes[1].plot(cre["iwp"], cre["net"], color="black", label="Net")
...
# Colorbar 1 (top)
cb_ax1 = fig.add_axes([box.x1 + cb_pad, box.y0 + cb_height + cb_pad, cb_width, cb_height])
